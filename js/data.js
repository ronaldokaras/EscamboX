...
/**
 * Gera o próximo ID sequencial e o persiste.
...
function save() {
    try {
        ...
        showToast && showToast('Erro ao salvar dados.', 'error');
    }
}
...
/**
 * Altera as moedas do usuário, garantindo saldo não negativo.
 * @param {Object} user - Usuário
 * @param {number} delta - Variação (positivo para crédito, negativo para débito)
...
/**
 * Adiciona uma notificação para o usuário.
    ...
    DB.items = [
        {
            ...
            desc: 'Bateria 89%, com capinha e película.',
        ...
        },
        {
            ...
            desc: 'Edição de bolso, pouco uso.',
            category: 'Livros',
            condition: 'usado',
            type: 'trade',
            price: 0,
        ...
        },
        {
            id: 104,
            ownerId: 1,
            title: 'Cafeteira italiana 6 xícaras',
            desc: 'Moka pot em inox.',
            category: 'Casa',
            condition: 'seminovo',
            type: 'both',
            price: 35,
        ...
        },
        {
            ...
            desc: 'Autonomia de 5h, case incluso.',
            category: 'Eletrônicos',
            condition: 'novo',
            type: 'sale',
            price: 75,
...
/**
 * Inicializa as senhas padrão para usuários sem hash.
 * Usuários comuns recebem '123', admin recebe 'admin123'.
 */
...
/**
 * Carrega os dados do localStorage ou inicializa com seed se versão diferente.
 * @returns {boolean} True se foi necessário criar seed (novo schema)
 */
function loadData() {
