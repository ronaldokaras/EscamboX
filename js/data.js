...
const SCHEMA_VERSION = 'v10'; // Itens aceitam troca por padrão // Imagens corretas + localização nos usuários
const KEYS = {
    users: 'exUsers',
    items: 'exItems',
    trades: 'exTrades',
...
function seed() {
    ...
    DB.items = [
        ...
        { id: 202, ownerId: 2, title: 'Fone Bluetooth TWS', desc: 'Autonomia de 5h, case incluso.', category: 'Eletrônicos', condition: 'novo', type: 'both', price: 75, acceptTrades: true, image: IMG.foneTws, status: 'available', views: 48, createdAt: now - 864e5, priceHistory: [], lat: -22.9035, lng: -43.1780, location: 'Rio de Janeiro, RJ' },
        ...
        // Ana – Belo Horizonte
        { id: 301, ownerId: 3, title: 'Jaqueta Jeans M', desc: 'Nova sem etiqueta.', category: 'Roupas', condition: 'novo', type: 'both', price: 60, acceptTrades: true, image: IMG.jaqueta, status: 'available', views: 21, createdAt: now - 7 * 864e5, priceHistory: [], lat: -19.9167, lng: -43.9345, location: 'Belo Horizonte, MG' },
        ...
        { id: 303, ownerId: 3, title: 'Luminária de Mesa LED', desc: 'Ideal para estudos, luz branca.', category: 'Casa', condition: 'novo', type: 'both', price: 25, acceptTrades: true, image: IMG.luminaria, status: 'available', views: 8, createdAt: now - 2 * 864e5, priceHistory: [], lat: -19.9300, lng: -43.9500, location: 'Belo Horizonte, MG' },

        // Carlos – Curitiba
        { id: 401, ownerId: 4, title: 'Notebook Dell Inspiron', desc: 'i5, 8GB RAM, 256GB SSD.', category: 'Eletrônicos', condition: 'seminovo', type: 'both', price: 850, acceptTrades: true, image: IMG.notebook, status: 'available', views: 55, createdAt: now - 6 * 864e5, priceHistory: [], lat: -25.4284, lng: -49.2733, location: 'Curitiba, PR' },
        ...
        { id: 403, ownerId: 4, title: 'Panela Elétrica de Arroz', desc: 'Capacidade 3 litros.', category: 'Casa', condition: 'novo', type: 'both', price: 55, acceptTrades: true, image: IMG.panelaArroz, status: 'available', views: 14, createdAt: now - 3 * 864e5, priceHistory: [], lat: -25.4200, lng: -49.2700, location: 'Curitiba, PR' },
        { id: 404, ownerId: 4, title: 'Mesa de Centro Rústica', desc: 'Madeira de demolição, 1,2m x 0,6m.', category: 'Casa', condition: 'usado', type: 'both', price: 120, acceptTrades: true, image: IMG.mesaCentro, status: 'available', views: 18, createdAt: now - 4 * 864e5, priceHistory: [], lat: -25.4310, lng: -49.2760, location: 'Curitiba, PR' },

        // Roberta – União da Vitória / Porto União
        { id: 501, ownerId: 5, title: 'Geladeira Electrolux 260L', desc: 'Branca, funcionando perfeitamente.', category: 'Casa', condition: 'seminovo', type: 'both', price: 380, acceptTrades: true, image: IMG.geladeira, status: 'available', views: 25, createdAt: now - 5 * 864e5, priceHistory: [], lat: -26.2220, lng: -51.0860, location: 'União da Vitória, PR' },
        ...
        { id: 503, ownerId: 5, title: 'Furadeira Bosch', desc: 'Impacto, com maleta.', category: 'Outros', condition: 'seminovo', type: 'both', price: 85, acceptTrades: true, image: IMG.furadeira, status: 'available', views: 20, createdAt: now - 3 * 864e5, priceHistory: [], lat: -26.2230, lng: -51.0880, location: 'Porto União, SC' },
        { id: 504, ownerId: 5, title: 'Kit Churrasco', desc: 'Espetos, grelha, faca e tábua.', category: 'Casa', condition: 'novo', type: 'both', price: 45, acceptTrades: true, image: IMG.churrasco, status: 'available', views: 9, createdAt: now - 2 * 864e5, priceHistory: [], lat: -26.2210, lng: -51.0850, location: 'União da Vitória, PR' },
        ...
        // Paula Freitas
        { id: 601, ownerId: 5, title: 'Roçadeira a Gasolina', desc: 'Motor 52cc, pouco uso.', category: 'Outros', condition: 'usado', type: 'both', price: 180, acceptTrades: true, image: IMG.rocadeira, status: 'available', views: 28, createdAt: now - 4 * 864e5, priceHistory: [], lat: -26.2150, lng: -50.9310, location: 'Paula Freitas, PR' },
        { id: 602, ownerId: 5, title: 'Par de Botas de Couro', desc: 'Tamanho 40, impermeável.', category: 'Roupas', condition: 'seminovo', type: 'both', price: 95, acceptTrades: true, image: IMG.botas, status: 'available', views: 11, createdAt: now - 5 * 864e5, priceHistory: [], lat: -26.2160, lng: -50.9320, location: 'Paula Freitas, PR' },
        { id: 603, ownerId: 5, title: 'Aparador de Grama Elétrico', desc: 'Largura de corte 30cm.', category: 'Outros', condition: 'novo', type: 'both', price: 120, acceptTrades: true, image: IMG.aparador, status: 'available', views: 7, createdAt: now - 2 * 864e5, priceHistory: [], lat: -26.2140, lng: -50.9300, location: 'Paula Freitas, PR' },

        // Variados
        { id: 701, ownerId: 1, title: 'Tênis Nike Air Max', desc: 'Tamanho 42, usado poucas vezes.', category: 'Roupas', condition: 'seminovo', type: 'both', price: 120, acceptTrades: true, image: IMG.tenis, status: 'available', views: 71, createdAt: now - 4 * 864e5, priceHistory: [], lat: -23.5500, lng: -46.6200, location: 'São Paulo, SP' },
        { id: 702, ownerId: 2, title: 'Óculos de Sol Ray-Ban', desc: 'Originais, com case.', category: 'Roupas', condition: 'usado', type: 'both', price: 90, acceptTrades: true, image: IMG.oculos, status: 'available', views: 43, createdAt: now - 10 * 864e5, priceHistory: [], lat: -22.9000, lng: -43.1600, location: 'Rio de Janeiro, RJ' },
        { id: 703, ownerId: 3, title: 'Relógio Casio', desc: 'À prova d\'água, pulseira de aço.', category: 'Roupas', condition: 'novo', type: 'both', price: 35, acceptTrades: true, image: IMG.relogio, status: 'available', views: 29, createdAt: now - 5 * 864e5, priceHistory: [], lat: -19.9100, lng: -43.9300, location: 'Belo Horizonte, MG' },
        { id: 704, ownerId: 4, title: 'Mochila Executiva', desc: 'Com porta-notebook.', category: 'Roupas', condition: 'novo', type: 'both', price: 45, acceptTrades: true, image: IMG.mochila, status: 'available', views: 18, createdAt: now - 2 * 864e5, priceHistory: [], lat: -25.4400, lng: -49.2600, location: 'Curitiba, PR' },
        { id: 705, ownerId: 1, title: 'Teclado Mecânico Gamer', desc: 'RGB, switches blue.', category: 'Eletrônicos', condition: 'seminovo', type: 'both', price: 150, acceptTrades: true, image: IMG.teclado, status: 'available', views: 82, createdAt: now - 1 * 864e5, priceHistory: [], lat: -23.5400, lng: -46.6300, location: 'São Paulo, SP' },
        ...
        { id: 707, ownerId: 3, title: 'Patinete Elétrico', desc: 'Autonomia de 15km.', category: 'Outros', condition: 'seminovo', type: 'both', price: 350, acceptTrades: true, image: IMG.patinete, status: 'available', views: 66, createdAt: now - 3 * 864e5, priceHistory: [], lat: -19.9250, lng: -43.9350, location: 'Belo Horizonte, MG' },
        { id: 708, ownerId: 4, title: 'Fone de Ouvido Bluetooth Over-Ear', desc: 'Cancelamento de ruído.', category: 'Eletrônicos', condition: 'novo', type: 'both', price: 110, acceptTrades: true, image: IMG.foneOver, status: 'available', views: 57, createdAt: now - 2 * 864e5, priceHistory: [], lat: -25.4100, lng: -49.2500, location: 'Curitiba, PR' },
        ...
        { id: 710, ownerId: 2, title: 'Kit Ferramentas 20 peças', desc: 'Chaves e alicates.', category: 'Outros', condition: 'novo', type: 'both', price: 40, acceptTrades: true, image: IMG.ferramentas, status: 'available', views: 5, createdAt: now - 1 * 864e5, priceHistory: [], lat: -22.9150, lng: -43.1650, location: 'Rio de Janeiro, RJ' },
        { id: 711, ownerId: 3, title: 'Vestido de Festa', desc: 'Tamanho P, usado uma vez.', category: 'Roupas', condition: 'seminovo', type: 'both', price: 30, acceptTrades: true, image: IMG.vestido, status: 'available', views: 13, createdAt: now - 4 * 864e5, priceHistory: [], lat: -19.9150, lng: -43.9250, location: 'Belo Horizonte, MG' },
        { id: 712, ownerId: 4, title: 'Monitor 24" LED', desc: 'Full HD, HDMI.', category: 'Eletrônicos', condition: 'usado', type: 'both', price: 220, acceptTrades: true, image: IMG.monitor, status: 'available', views: 31, createdAt: now - 9 * 864e5, priceHistory: [], lat: -25.4000, lng: -49.2400, location: 'Curitiba, PR' },
        { id: 713, ownerId: 1, title: 'Alexa Echo Dot 3ª Geração', desc: 'Pouco uso, com caixa original.', category: 'Eletrônicos', condition: 'seminovo', type: 'both', price: 70, acceptTrades: true, image: IMG.alexa, status: 'available', views: 49, createdAt: now - 2 * 864e5, priceHistory: [], lat: -23.5600, lng: -46.6500, location: 'São Paulo, SP' }
    ];
